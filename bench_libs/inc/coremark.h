...
#include "functions.h"   //for klessydra library and function like the functions to disable threads.
#include "core_portme.h"

#if HAS_STDIO
#include <stdio.h>
#endif
#include "../../string_lib/inc/string_lib.h"
#if HAS_PRINTF
