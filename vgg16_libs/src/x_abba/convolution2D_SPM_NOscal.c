...
void convolution2D_SPM(void* spm_dest, void* spm_fm, void* spm_krn, int size)
{
  ...
  CSR_MVSIZE(2*sizeof(int));
	for(int i=1; i< size-1;i++){
		...
		kern_offset	=	0;
		fm_offset= (size-1-1);
		kdotp32(dest_in_D,		(void*)(	(int*)spmaddrA+	(i-1)*size			+fm_offset	),	(void*) ( (int*)spmaddrB+(0)*jump_kr_row+	kern_offset ));
		kdotp32(dest_in_B,		(void*)(	(int*)spmaddrA+	(i)*size				+fm_offset	),	(void*) ( (int*)spmaddrB+(1)*jump_kr_row+	kern_offset ));
    kaddv(dest_in_D, dest_in_B, dest_in_D);
    kaddv(dest_in_C, dest_in_C, dest_in_D);
		kdotp32(dest_in_D,		(void*)(	(int*)spmaddrA+	(i+1)*size			+fm_offset	),	(void*) ( (int*)spmaddrB+(2)*jump_kr_row+	kern_offset ));
		kaddv(dest_in_C, dest_in_C, dest_in_D);
	}
	if(print){
  ...
  dest_in_B	= 	(void*)spmaddrB + sizeof(int)*12*shift_spmB; //shift_spmB=1
	...
	kern_offset	=	1;
	fm_offset		=	0;
	kdotp32(dest_in_D,		(void*)(	(int*)spmaddrA+	(0)*size			+fm_offset	),	(void*) ( (int*)spmaddrB+(1)*jump_kr_row+	kern_offset ));
	kdotp32(dest_in_B,		(void*)(	(int*)spmaddrA+	(1)*size			+fm_offset	),	(void*) ( (int*)spmaddrB+(2)*jump_kr_row+	kern_offset ));
  ...
  dest_in_B	=		(void*)spmaddrB + sizeof(int)*12*shift_spmB; //shift_spmB=3
	...
	kern_offset	=	1;
	fm_offset		=	0;
	kdotp32(dest_in_D,		(void*)(	(int*)spmaddrA+	(size-1-1)*size			+fm_offset	),	(void*) ( (int*)spmaddrB+(0)*jump_kr_row+	kern_offset ));
	kdotp32(dest_in_B,		(void*)(	(int*)spmaddrA+	(size-1)	*size			+fm_offset	),	(void*) ( (int*)spmaddrB+(1)*jump_kr_row+	kern_offset ));
